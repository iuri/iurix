ad_page_contract {
    ...
    @cvs-id $Id: proc-view.tcl,v 1.16.2.5 2020/10/28 15:39:18 hectorr Exp $
} {
    proc:nohtml,trim
...
set procViewToggleURL [export_vars -base proc-view -no_empty {proc {source_p "[expr {!$source_p}]"} version_id}]
