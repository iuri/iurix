--
-- Drop Notifications for audios package
--
...
begin
    for row in select nt.type_id
               ...
               where nt.short_name in (''audios_audio_notif'', ''audio_item_notif'')
    loop
...
begin
        ...
        impl_id := acs_sc_impl__get_id (
                      ...
                      ''audios_audio_notif_type''	-- impl_name
        );
	...
	and short_name = ''audios_audio_notif'';
	...
	from notification_types
	where sc_impl_id = impl_id
	and short_name = ''audio_item_notif'';
