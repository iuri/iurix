...
set add_tag_link [tags::create_link -item_id $audio_id -link_text "Add a Tag" -return_url $return_url]
...
db_multirow -extend {image_audio_url} related_audios select_related_audios {} {
