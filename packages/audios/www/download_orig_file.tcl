...
set item_id $audio_id
ad_require_permission $audio_id "read"

set version_id [db_string item "select revision_id from cr_revisions where item_id = :audio_id order by revision_id limit 1" -default ""]
