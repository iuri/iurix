...
set invitation_queued_p [db_0or1row select_room_id {
    SELECT room_id FROM chat_invitation_queue WHERE room_id = :room_id
}]

if {$active_users eq 0 && [info exists invitation_queued_p]} {
