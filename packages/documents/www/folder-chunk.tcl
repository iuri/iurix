...
ns_log Notice "PAGE FOLDERCHUNK.TCL"
ns_log Notice "FOLDERID $folder_id"
ns_log Notice "$keyword"
...
set add_url [export_vars -base "${fs_url}document-ae" {folder_id}]
...
db_multirow -extend {label alt_icon icon last_modified_pretty content_size_pretty properties_link properties_url download_link download_url new_version_link new_version_url views categories} contents select_folder_contents_all {} {
    ...
    switch -- $type {
        ...
        symlink {
            ...
            set properties_url [export_vars -base "${fs_url}file" {{file_id $object_id} {folder_id}}]
            set new_version_link [_ acs-kernel.common_New]
            set new_version_url [export_vars -base "${fs_url}document-ae" {{file_id $object_id} {folder_id}}]
        ...
        default {
            set properties_link [_ file-storage.properties]
            set properties_url [export_vars -base "${fs_url}document-ae" {{file_id $object_id} {folder_id}}]
            set new_version_link [_ acs-kernel.common_New]
            set new_version_url [export_vars -base "${fs_url}document-ae" {{file_id $object_id} {folder_id}}]
            set icon "/resources/file-storage/file.gif"
            set alt_icon "#file-storage.file#"
