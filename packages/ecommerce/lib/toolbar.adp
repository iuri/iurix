...
<div style="text-align:right;">
  ...
  <if @gift_certificates_are_allowed@ true and @current_location@ ne "gift-certificate"> 
    [&nbsp;<a href="@ec_gift_cert_order_link@">#ecommerce.gift_certificates#</a>&nbsp;] 
  </if>
...
<input type="hidden" name="display" value="1">
 ...
 &nbsp;]
    ...
    [&nbsp;<a href="@ec_cart_link@" title="View the contents of your shopping cart">#ecommerce.shopping_cart#</a>&nbsp;]
  </else>
 </if>
 <if @current_location@ ne "your-account"> 
    [&nbsp;<a href="@ec_account_link@" title="View your @ec_system_name@ account">#ecommerce.My_account#</a>&nbsp;]
 </if>
