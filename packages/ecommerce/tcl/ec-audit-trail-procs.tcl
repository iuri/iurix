...
ad_library {
    ...
    @cvs-id $Id: ec-audit-trail-procs.tcl,v 1.9 2008/08/25 11:59:22 torbenb Exp $
...
ad_proc ec_audit_trail {
    ...
    ns_log Notice "Running TCL script ec_audit_trail..."
	...
	ns_log Notice "ID OCLUMN $id_column ******"
	incr count
  ...
  order by $main_table_name.last_modified asc"
    ...
    ns_log Notice "END ec_audit_trail..."
...
be given the calling arguments for ec_audit_trail.
	...
	ns_log Notice "Running TCL sctip ec_audit_trail_for_table ... $id_column"
