...
ad_proc -public ec_creditcard_authorization { 
    ...
    set currency [parameter::get -parameter Currency -package_id [ec_id] -default "BRL"]

    # Lookup the selected payment gateway
    set payment_gateway [parameter::get -parameter PaymentGateway -default [parameter::get -package_id [ec_id] -parameter PaymentGateway]]
    ns_log Notice "PAYMENT GATEWAY PARAM $payment_gateway"
