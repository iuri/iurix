ad_library {
    ...
    @cvs-id $Id: ecommerce-widgets-procs.tcl,v 1.23 2009/02/12 06:29:07 torbenb Exp $
...
ad_proc ec_combocategory_widget { 
    ...
    if { $multiple_p == "f" } {
        set select_tag "<select name=\"combocategory_id\"><option value=\"\">#ecommerce.Entire_catalog#</option>\n"
    } else {
        set select_tag "<select multiple name=\"category_id\" size=\"3\"><option value=\"\">#ecommerce.Entire_catalog#</option>\n"
    }
    set to_return ""
...
ad_proc ec_rating_widget { } { ratings widget } {
    return "
<div class=\"row\"><div class=\"col-2\"><input type=radio name=rating value=5> [ec_display_rating 5] &nbsp; [_ ecommerce.5_Stars]</div></div>
<div class=\"row\"><div class=\"col-2\"><input type=radio name=rating value=4 default> [ec_display_rating 4] &nbsp; [_ ecommerce.4_Stars]</div></div>
<div class=\"row\"><div class=\"col-2\"><input type=radio name=rating value=3> [ec_display_rating 3] &nbsp; [_ ecommerce.3_Stars]</div></div>
<div class=\"row\"><div class=\"col-2\"><input type=radio name=rating value=2> [ec_display_rating 2] &nbsp; [_ ecommerce.2_Stars]</div></div>
<div class=\"row\"><div class=\"col-2\"><input type=radio name=rating value=1> [ec_display_rating 1] &nbsp; [_ ecommerce.1_Star]</div></div>
