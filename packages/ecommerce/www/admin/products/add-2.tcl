...
ad_page_contract {
  ...
  @cvs-id $Id: add-2.tcl,v 1.12 2008/10/11 11:51:15 torbenb Exp $
...
ns_log Notice "ORG $organization_id"
...
if { [info exists upload_file] && [string length $upload_file] > 4 } {
    ...
    ns_log Notice "UPLOAD FILE $upload_file | [file extension $upload_file] | ${upload_file.tmpfile}"
