...
ad_page_contract {
  ...
  @cvs-id $Id: edit-2.tcl,v 1.15 2008/08/28 20:58:50 torbenb Exp $
...
ns_log Notice "Running TCL script edit-2.tcl"
...
ns_log Notice "AFTER COMPARE URL"
...
ns_log Notice "AFTER MAKE IMAGE"
...
if { $multiple_retailers_p } {
    ...
    if { ![empty_string_p $stock_status] } {
        set stock_status_html [util_memoize "parameter::get -package_id [ec_id] -parameter \"StockMessage[string toupper [string range $stock_status 0 0]]\"" [ec_cache_refresh]]
    }
