...
ad_page_contract {
  ...
  @cvs-id $Id: edit-3.tcl,v 1.5 2008/11/15 12:15:41 torbenb Exp $
...
ns_log Notice "Running TCL script edit-3.tcl"
...
ns_log Notice "AUDIT $audit_update ******" 
db_transaction {
  ...
  ns_log Notice "AFTER PRODUCT UPDATE"
  ...
  ns_log Notice "AFTER IF COLUMNS NOT == 0"
...
ns_log Notice "AFTER PRICE UPDATE"
