...
ad_page_contract {
  ...
  @cvs-id $Id: index.tcl,v 1.8 2009/02/18 10:20:34 torbenb Exp $
...
set list_all_url [export_vars -base list {organization_id}]
set add_url [export_vars -base list {organization_id}]
