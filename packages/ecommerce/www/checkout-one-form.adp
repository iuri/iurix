<master src="master">
  ...
  <property name="context">@context;noquote@</property>
    ...
    <div class="page-wrapper" style="margin:6% 10%; min-height:780px;background-color:#fff; border:5px solid #fff; border-radius:10px;width:75%; text-align:center;">
...
<h3>#ecommerce.My_orders#</h3>
 @items_ul;noquote@
<hr>
<h4>#ecommerce.Complete_this_info_lt#</h4>

<table border="0" bgcolor="#eeeeee"><form method="post" action="checkout-one-form-2">
@hidden_vars;noquote@
<tr><td colspan="2"><h5>#ecommerce.Bill_to#</h5></td>
