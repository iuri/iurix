...
ns_log Notice "Running TCL script finalize-order.tcl"
...
ns_log Notice "HARD GOODS COST $hard_goods_cost "
if {$hard_goods_cost > 0} {
	...
	if {$applied_certificate_amount >= [expr $soft_goods_cost + $soft_goods_tax]} {
		...
		ns_log Notice " BEFORE ec_creditcard_authorization | $order_id | $transaction_id | $card_code"
