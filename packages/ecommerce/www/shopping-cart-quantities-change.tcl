...
ad_page_contract {
    ...
    @creation-date
    @cvs-id $Id: shopping-cart-quantities-change.tcl,v 1.8 2008/09/29 13:40:30 torbenb Exp $
    @author ported by Jerry Asher (jerry@theashergroup.com)
} {
    return_url:optional
    {color_choice:multiple,optional}
    {style_choice:multiple,optional}
    {size_choice:multiple,optional}
    {quantity ""}
}
...
ns_log Notice "ORDERID $order_id"
