...
<div class="cbp-spmenu-push" style="background-color:#f1f1f1;">
  <div class="main-content">
    <include src="/packages/evex-theme/lib/header">         

    <h1>#evex-item.Your_shopping_cart#</h1>

    <div class="page-wrapper" style="margin:6% 15%; background-color:#fff; border:5px solid #fff; border-radius:10px;width:75%;">
    <br><br>
...
<if @paypal_standard_mode@ eq 0>
  ...
  <else>
    <center>Your Shopping Cart is empty.
    <img src="https://www.evex.co/themes/front/ico/shopping-cart-empty.svg" style="width:10%;">
    </center>
  </else>

  <ul>
    <li> <a href="@request_proposal_url@">#ecommerce.Request_proposal#</a> </li> 
...
<include src="/packages/evex-theme/lib/copyright">
