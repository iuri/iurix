...
<if @product_counter@ gt 1> <td>Subtotal</td> </if>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="quantity.@in_cart.product_id@ {@in_cart.color_choice@} {@in_cart.size_choice@} {@in_cart.style_choice@}" value="@in_cart.quantity@" size="@max_quantity_length@" maxlength="@max_quantity_length@">
      </td>
