...
<% 
   ...
   set wsUri "ws://192.199.241.130:5008/api/subscribe?auth_token=9fb6e731-b342-4952-b0c1-aa1d0b52757b&event_type=extract"
%>
<html>
	<head>
	  <title>ws log</title>
	      ...
	      <script language="javascript" type="text/javascript">  
			...
			function init() {
			   ...
			   $('#logctl').change(function(){
			     ...
			     $.ajax({ url: "192.199.241.130:5008/api/subscribe?auth_token=9fb6e731-b342-4952-b0c1-aa1d0b52757b&event_type=extract", data: formData });
			    });
			}
