...
ad_proc -private layout_manager::install::after_upgrade {
    ...
    apm_upgrade_logic \
	    ...
	    1.0.2 1.0.3 {
		db_dml add_customize_column { alter table layout_pagesets add column customize boolean default 'f' }
	    }
        }
}

ad_proc layout_manager::install::before_uninstall {} {
    Package before installation callback proc
} {
