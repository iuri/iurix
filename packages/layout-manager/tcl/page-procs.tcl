ad_library {
    ...
    @version $Id: page-procs.tcl,v 1.9 2010/07/28 00:28:33 donb Exp $
...
ad_proc layout::page::new {
    ...
    @param url_name The page name to use for navigation.  If blank, it will be automatically generated from the name.
...
ad_proc -private layout::page::get {
	...
	set page_id [db_string select_page_id {
	    SELECT page_id FROM layout_pages WHERE sort_key = 0 AND pageset_id = (SELECT pageset_id FROM layout_pagesets WHERE package_id = :package_id)
	}]	
    }
