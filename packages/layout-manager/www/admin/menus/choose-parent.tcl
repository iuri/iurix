...
#ns_log Notice "PKG_ID $package_id |$pageset_id"
...
set result [db_list select_item "$main_sql"]
if {![exists_and_not_null t]} { 
    ad_returnredirect [export_vars -base new {return_url {url $referal_url}}]
}
...
append table "
  <td colspan=$colspan_level>
    <A href=new?url=$referal_url&return_url=$return_url>#layout-manager.Skip_parent_menu#</A>
  </td>
"
