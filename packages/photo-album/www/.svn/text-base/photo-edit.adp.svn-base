  ...
  <table>
	...
	<table>
	    ...
	    <td>
          ...
          <tr>
	    <td>
	      #photo-album.Author#: <formwidget id=photographer></formwidget>
	    </td>
	  </tr>
          <tr>
	    <td>
	      #photo-album.Community#: <formwidget id=community_id></formwidget>
	    </td>
	  </tr>
          <tr>
	    <td>
	    ...
	    <td>
          ...
          <tr>
	    <td>
	      #photo-album.Tags#:<formwidget id=tags></formwidget>
	    </td>
	  </tr>
	</table>
      </td>
