...
template::head::add_css -href "css/reset.css" -media all
#template::head::add_css -href "css/gallery.css" -media all
template::head::add_css -href "css/slideflow.css" -media all
template::head::add_script -type "text/javascript" -src "js/scriptaculous/lib/prototype.js"
template::head::add_script -type "text/javascript" -src "js/scriptaculous/src/scriptaculous.js?load=effects"
template::head::add_script -type "text/javascript" -src "js/slideflow/slideflow.js"
template::head::add_script -type "text/javascript" -src "js/slideflow/slider.js"
template::head::add_script -type "text/javascript" -src "js/slideflow/scrolling.js"
template::head::add_script -type "text/javascript" -src "js/xmlparser/xmlparser.js"
