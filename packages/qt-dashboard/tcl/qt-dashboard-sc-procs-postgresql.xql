...
<fullquery name="qt_face_datasource">
      <querytext>
...
<fullquery name="qt_face_get_package_id">
      <querytext>
...
<fullquery name="qt_face_get_url_stub">
      <querytext>
...
<fullquery name="qt_vehicle_datasource">
      <querytext>
	select r.revision_id as object_id,
	       i.name as title,
	       (case i.storage_type
...
<fullquery name="qt_vehicle_get_package_id">
      <querytext>
	select f.package_id as package_id
	  from fs_root_folders f,
       	  (select i2.parent_id
...
<fullquery name="qt_vehicle_get_url_stub">
      <querytext>
        select site_node__url(node_id) as url_stub
        from site_nodes
        where object_id=:package_id
