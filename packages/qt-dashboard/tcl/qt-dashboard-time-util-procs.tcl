...
ad_proc qt::util::clock_scan_interval { seconds delta units } {
...
ad_proc qt::util::interval_ymdhs { s1 s2 } {
...
ad_proc qt::util::interval_ymdhs_w_units { t1 t2 } {
...
ad_proc qt::util::interval_remains_ymdhs { s1 s2 } {
...
ad_proc qt::util::interval_remains_ymdhs_w_units { t1 t2 } {
