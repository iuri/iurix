...
BEGIN
    for row in select type_id
                ...
                where short_name in ('qt_face_matching_notif')
    loop
...
BEGIN
        ...
        impl_id := acs_sc_impl__get_id (
                      ...
                      'qt_face_matching_notif_type'	-- impl_name
        );
        ...
        v_foo := acs_sc_impl_alias__delete (
                    'NotificationType',		-- impl_contract_name	
                    'qt_face_matching__notif_type',		-- impl_name
	...
	select into v_foo type_id 
	 ...
	 where sc_impl_id = impl_id
	  and short_name = 'qt_face_matching_notif';
