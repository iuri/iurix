...
namespace eval qt::twilio {}

ad_proc -public qt::twilio::send_input_number_validation {} {
    It sends message to the user through Twilio's API, warning to verify and resend its message properly
} {
...
ad_proc -public qt::twilio::send {
    {-creation_user}
} {
    It sends messages to users through POST requests to Twilio's API
} {
    ...
    set req_headers [ns_set create]
    ns_set put $req_headers Authorization "Basic $auth_token"
    ns_set put $req_headers Content-Type "application/x-www-form-urlencoded"
	...
	switch $count {
		...
		set formvars [export_vars -url {{To "whatsapp:+5511998896571"} {From $source} {Body $body}}]
		#set res [util::http::post -url $url -headers $req_headers -formvars $formvars -multipart]
		set res [util::http::post -url $url -headers $req_headers -formvars $formvars]  
