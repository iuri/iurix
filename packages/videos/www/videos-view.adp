...
<table width="100%" cellpadding="5" cellspacing="0">
  <tr>
	...
	#videos.Author#: @video.autor;noquote@<br>
	#videos.Community#: @community_name;noquote@<br>

<%
foreach {category_id category_name } [videos::get_categories -package_id $package_id] {
	set category_value [category::get_name [videos::get_category_child_mapped -category_id $category_id -object_id $video_id]]
%>
	@category_name@: @category_value@<br>
<%
}
%>
	#videos.Source#: @video.source;noquote@<br>
	#videos.Posted_by#: @creator_name@<br>
      ...
      <a href="http://www.linkedin.com/shareArticle?mini=true&url=@return_url@&title=@video.video_name@&summary=@video.video_description@&source=@video.source@"><img src="/resources/videos/linkedin_icon.gif" width="100" border=0 alt="Share on Linkedin"></a>
    ...
    <td width="60%" valign="top" align="left">
      <div class="videos"> 
		...
		<script type='text/javascript'>
		 ...
		 so.addVariable('file','@url@@video_id;noquote@.mp4');
